...
export const videos = [
  ...
  {
    id: "3",
    title: "چگونه نفت یک کشور را نفرین می‌کند؟",
    channel: {
      name: "Choraz - چُراز",
      id: "chorazmedia",
      profileUrl:
        "https://yt3.googleusercontent.com/5_0bNE_HJJp9A9BCGpcnZt3_OnNAXSKFZo9xcZpSKDBPp1d8rxQXu54wzPME63odCUsUGYRyqg=s160-c-k-c0x00ffffff-no-rj",
    },
    views: 17432,
    postedAt: new Date("2024-06-18"),
    duration: 2439,
    thumbnailUrl:
      "https://i.ytimg.com/vi/fqx_ihT9v5M/hq720.jpg?sqp=-oaymwEcCNAFEJQDSFXyq4qpAw4IARUAAIhCGAFwAcABBg==&rs=AOn4CLCf2MDMTQey43IfHuSpYZjPge64BA",
    videoUrl:
      "https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4",
  },
  {
